...
class Pio_Plugin implements Typecho_Plugin_Interface{
    ...
    public static function config(Typecho_Widget_Helper_Form $form){
        ...
        function paul_update($name, $version){
            ...
            echo "<p>By: Dreamer-Paul</p>";
            echo "<p class='buttons'><a href='javascript:void 0;'>项目介绍</a><a href='javascript:void 0;'>更新日志</a></p>";
            $update = ['text' => '暂无更新','message'=>'当前为最新版本'];
        ...
        // 选择模型
        $choose_models = new Typecho_Widget_Helper_Form_Element_Checkbox('choose_models', $models, 'pio', _t('选择模型'), _t('选择插件目录下的模型目录，并确定配置文件名为 <a>model.json</a>'));
