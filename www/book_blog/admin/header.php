...
<link rel="shortcut icon" type="image/x-icon" href="extend/favicon.ico" />
<link rel="stylesheet" type="text/css" href="extend/admin_custom.css">
<!--[if lt IE 9]>
...
<html class="no-js">
    <head>
		...
		<link rel="stylesheet" type="text/css" href="extend/user.css?v=1.02">
	    <link rel="stylesheet" type="text/css" href="extend/user-style.css?v=1.02">
		<script>
		var UserLink="<?php $options->adminUrl('profile.php'); ?>";
		var UserPic="<?php $email =$user->mail; if($email){if(strpos($email,'@qq.com') !==false){$email=str_replace('@qq.com','',$email);echo 'http://q1.qlogo.cn/g?b=qq&nk='.$email.'&';}else{$email= md5($email);echo '//cdn.v2ex.com/gravatar/'.$email.'?';}}else{echo '//cdn.v2ex.com/gravatar/null?';} ?>";
